    ...
    public class StudentServiceTests
    {
        ...
        public StudentServiceTests()
        {
            ...
            UnitOfWork = new UnitOfWork(new Context(options));
              ...
              _studentService = new StudentService(UnitOfWork, _mockLogger.Object, _userManager);
        }
        ...
        public async Task Search_ReturnsViewResultNull()
        {
            ...
            //Act
            var result = await _studentService.IndexView(searchString, EnumSearchParameters.Surname,currentPage, pageSize);
        ...
        public async Task SearchName_ReturnsViewResult()
        {
            ...
            //Act
            var result = await _studentService.IndexView(searchString, EnumSearchParameters.Name, currentPage, pageSize);
